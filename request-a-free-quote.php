...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/request-a-free-quote.css">
</head>
                ...
                <div class="form-group">
                    <table>
                        <tr>
                            ...
                            <td>
                                <div class="table-td">
                                    <p>Mattress:</p><input type="text" placeholder="0">
                                </div>
                            </td>
                            <td>
                                <div class="table-td">
                ...
                <div class="form-group">
                    <table>
                        <tr>
                            <td>
                                <div class="table-contact">
                                        <p>Pick Up Address:*</p><div class="_address_">
                                        <input type="text" class="add-a" ><br>(Pick up) Street Address
                                        <div class="address_">
                            ...
                            <td>
                                <div class="table-contact">
                                        <p>Drop Off Address:</p><div class="_address_">
                                        <input type="text" class="add-a"><br>(Drop off) Street Address
                                        <div class="address_">
                                            <span><input type="text"><br>City</span>
                                            <span><input type="text"><br>State</span>
                                        </div>
                        ...
                        <tr>
                            <td></td>
                            <td><button style="width: 100px;height:40px;color:white;background:tomato;border:0;cursor:pointer">Submit</button></td>
                        </tr>
                    </table>
                </div>
            </div>
