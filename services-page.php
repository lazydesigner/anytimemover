...
<head>
    ...
    <title>Services - Anytime Movers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/remixicon/3.5.0/remixicon.min.css" integrity="sha512-/VYneElp5u4puMaIp/4ibGxlTd2MV3kuUIroR3NSQjS2h9XKQNebRQiyyoQKeiGE9mRdjSCIZf9pb7AVJ8DhCg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="<?=base_url() ?>assets/css/footer.css">
    <link rel="stylesheet" href="<?=base_url() ?>assets/css/navbar.css">
    <link rel="stylesheet" href="<?=base_url() ?>assets/css/services-page.css">
</head>

<body>
    <div style="position:relative; width:100%;height:70px"><?php include './navbar.php'; ?></div>
    <div class="service-text-change">
        <h1 class="service-h2">Our Services</h1>
    </div>
    <section class="section-service">
        ...
        <div class="section-service-row">
            ...
            <div class="section-service-col">
                <a href="more-services" style="text-decoration: none;">
        ...
        <div class="section-service-row" style="margin: 2.5% 0;">
            ...
            <div class="section-service-col">
                <h2 style="color: #3366ff;font-size:2.2rem;">Questions?</h2>
