...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if($services_table == 'new_services'){
    ...
    }elseif($services_table == 'services'){
    $sql_query = "INSERT INTO services (title, slug, meta, h1, h1_about, h2, h2_about, content,added_on) VALUES ('$title', '$slug', '$meta', '$h1', '$h1_about', '$h2', '$h2_about', '$content','$timestamp')";
    $insert = mysqli_query($con, $sql_query) or die("insert query failed");
    }
