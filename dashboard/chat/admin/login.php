...
<body>
  <div class="login_form_body">
      <form action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]);?>" method="POST" class="form_main">
...
<button id="button" name="login">Submit</button>
...
<script>
  document.getElementById('button').addEventListener('click',()=>{
    ...
    fetch('https://dashboard.rapidautoshipping.com/chat/admin/authentication.php', {
      method:'POST',
      body:Formdata
    }).then(res=>res.json()).then(d=>{
      if(d['login'] == 'Success'){
        window.location.href= " https://dashboard.rapidautoshipping.com/chat-dashboard"
