...
<a href="<?=base_urlx() ?>services-page" style=cursor:pointer><button><i class=ri-shuffle-line></i>Learn More</button></a>
</div>
<div class=box>
...
<a href="<?=base_urlx() ?>more-services" style=cursor:pointer><button><i class=ri-shuffle-line></i>Learn More</button></a>
</div>
</div>
</section>
...
<div class=design>
<div class=line1 style=background-color:#f5f5f5></div>
<div class=line3 style=background-color:#f5f5f5></div>
<div class=line1 style=background-color:#f5f5f5></div>
</div>
...
<p>Whether you have a question, just want to say hello, or want to leave us a testimonial feel free to get in contact with us! Phone: <span style=color:#9f0a0a;font-weight:700>954-941-6848</span> or fill out your info and send us an e-mail. We look forward to hearing from you.</p>
<button class=contact-section-btn>For a Quote Click Here</button>
<div class=design style=margin-top:2.5%>
<div class=line1 style=background-color:#9f0a0a></div>
<div style=color:#9f0a0a;font-size:xx-large><i class=ri-arrow-drop-down-line></i></div>
<div class=line1 style=background-color:#9f0a0a></div>
</div>
...
<textarea name="" cols=30 rows=7 placeholder="Your Message"></textarea>
<div><label style=opacity:0>.<input type=checkbox name=terms id=terms></label><span style=color:#add8e6>I agree with this Site's Privacy Policy</span></div>
